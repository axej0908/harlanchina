...
import com.axej.harlan.cms.dao.GoodsStatisticsDao;
...
public class GoodsStatisticsServiceImpl implements GoodsStatisticsService{
    ...
    @Override
    public List<CmsStatisticsBean> queryUpDownStatistics(Map<String, Object> map) {
        ...
        if(dates.size() > 0){
            ...
            for(int i = 0; i < dates.size(); i++){
                ...
                CmsStatisticsBean cmsStatisticsBean = goodsStatisticsDao.queryUpDownStatistics(map);
