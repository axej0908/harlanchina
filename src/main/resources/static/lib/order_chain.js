var vm = new Vue({
    ...
    mounted: function () {
        this.$nextTick(function () {
            vm.getCurrentUser();
            vm.chain.order_id = getQueryString("order_id");
            vm.orderDetail();
            vm.chainDetail();
        ...
        uploadImg: function (event) {
            ...
            $.ajaxFileUpload({
                ...
                success: function (r, status) {
                    //文件路径
                    if (inputId == "upload") {
                        vm.chain.upload = r.data;
                        if(vm.chain.upload == null || typeof vm.chain.upload == "undefined"){
